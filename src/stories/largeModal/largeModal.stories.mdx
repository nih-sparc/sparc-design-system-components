...
Large Modal contains a named 'mainContent' slot which will place the content to the right of any content defined in the named 'optionalContent' slot.

## Events

`close-download-dialog`: This event will fire when the close (x) icon in the top right of the modal is clicked
